...
export const ordersApi = {
  ...
  markAsOutForDelivery: (orderId: string) => {
    return adminApiRequest(ADMIN_API_ENDPOINTS.orders.markOutForDelivery(orderId), {
      method: 'PATCH',
      headers: {
        'Content-Type': 'application/json',
        ...getAdminAuthHeaders(),
  ...
  confirmPayment: (orderId: string) => {
    return adminApiRequest(ADMIN_API_ENDPOINTS.orders.confirmPayment(orderId), {
      method: 'PATCH',
      headers: {
        'Content-Type': 'application/json',
        ...getAdminAuthHeaders(),
