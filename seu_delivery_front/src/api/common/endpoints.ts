...
export const PUBLIC_API_ENDPOINTS = {
  ...
  checkout: {
    create: '/checkout',
    pixSimples: '/checkout/pix-simples',
  },
  cart: {
    add: '/cart/add',
    remove: '/cart/remove',
...
export const ADMIN_API_ENDPOINTS = {
  ...
  orders: {
    ...
    markOutForDelivery: (id: string) => `/admin/orders/${id}/mark-out-for-delivery`,
    ...
    confirmPayment: (id: string) => `/admin/orders/${id}/confirm-payment`,
  },
  clients: {
    list: '/admin/clients',
