...
import { Store, Users, Building2, ChevronRight, Wallet, MessageCircle } from 'lucide-react';
...
type SettingsSection = 'menu' | 'store' | 'users' | 'branches' | 'bank' | 'whatsapp';
...
export function Settings() {
  ...
  const allSections = [
    ...
    },
    {
      ...
      title: 'WhatsApp',
      description: 'Conecte o WhatsApp via Evolution API para notificações automáticas',
      icon: MessageCircle,
      color: 'bg-green-600',
      roles: ['master', 'admin'] as const,
    },
                ...
                <CardContent className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    <div 
                      ...
                      style={{ 
                        backgroundColor: section.id === 'users' ? '#a855f7' 
                          : section.id === 'branches' ? '#22c55e' 
                          : section.id === 'whatsapp' ? '#16a34a'
                          : section.id === 'bank' ? '#f97316'
                          : '#3b82f6' 
                      }}
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mt-6">
        ...
        {sectionMounted && activeSection === 'whatsapp' && <WhatsAppSettings key="whatsapp" onBack={() => setActiveSection('menu')} />}
