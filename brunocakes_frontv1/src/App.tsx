...
function App() {
  ...
  const updateOrderStatus = async (orderId: string, status: Order['status']) => {
    try {
      const updated = await apiRequest(`${API_BASE_URL}/admin/orders/confirm-many`, {
        method: 'POST',
  ...
  // Novo useEffect para carregar pedidos do backend
  useEffect(() => {
    const fetchOrders = async () => {
      try {
        ...
        toast.error('Erro ao carregar pedidos do backend');
      }
    };
