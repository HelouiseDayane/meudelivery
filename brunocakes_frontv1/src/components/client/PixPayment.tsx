...
export function PixPayment() {
  ...
  // Removido: verificação mock de pagamento automático
  ...
  const handleManualConfirmation = async () => {
    if (!order?.pixPaymentId) return toast.error('Pagamento não encontrado.');
    try {
      // Chama o webhook de pagamento Pix
      // @ts-ignore
      await import('../../api').then(apiModule => apiModule.api.notifyPaymentWebhook(order.pixPaymentId!, 'paid'));
