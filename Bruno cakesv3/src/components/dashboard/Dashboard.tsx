  ...
  if (userType === 'admin') {
    return (
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl">Dashboard Administrativo</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl">{mockStats.admin.dailyOrders}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl">{mockStats.admin.pendingOrders}</div>
              <p className="text-xs text-muted-foreground">
                Requer atenção
              </p>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl">R$ {mockStats.admin.monthlyRevenue.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</div>
              <p className="text-xs text-muted-foreground">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl">{mockStats.admin.totalClients}</div>
              <p className="text-xs text-muted-foreground">
                +5 novos esta semana
              </p>
            </CardContent>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl">{mockStats.client.totalOrders}</div>
            <p className="text-xs text-muted-foreground">
              Total de pedidos
            </p>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl">{mockStats.client.favoriteProducts}</div>
            <p className="text-xs text-muted-foreground">
              Doces salvos
            </p>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl">R$ {mockStats.client.totalSpent.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</div>
            <p className="text-xs text-muted-foreground">
